...
//构造函数
	public TechFragment(int mPosition) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		//启动异步任务去访问网络
		getDataFromNet();
		View mView = inflater.inflate(R.layout.tech_listview, container, false);
		mLinearLayout  = (LinearLayout) mView.findViewById(R.id.fragment_layout);
		mListView = (ListView)mView.findViewById(R.id.keji_listid);
		//适配ListView 
		...
		scr = (ScrollView) mView.findViewById(R.id.shuaxinscr_id);
		shauxinbtn = (Button) mView.findViewById(R.id.kejishuaxinbtn_id);
	...
	private void getDataFromNet() {
		...
		final String path = "http://wangyi.butterfly.mopaasapp.com/news/api?type=tech&page=1&limit=8";
  ...
  //********************************!!!!!!!!!!***********************************
	...
	{
		M_PAGE++;
		String a  ="http://wangyi.butterfly.mopaasapp.com/news/api?type=tech&page=";
		String b = "&limit=8";
